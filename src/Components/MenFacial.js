...
import menfacialone from "../Assets/menfacialone.png";
import menfacialtwo from "../Assets/menfacialtwo.png";
import "../Styles/MenFacial.css"
import { useNavigate } from "react-router-dom";

const MenFacial = () => {
  const navigate=useNavigate()
const handleMenFacialBtn=()=>{
  ...
  return (
    <div className="facial-container">
      <h1 className="facial-title">Facial</h1>

      <div className="image-grid">
        <img src={facialone} alt="Facial room" className="img-large" />
        <img src={menfacialone} alt="Facial mask application" className="img-small-top" />
        <img src={menfacialtwo} alt="Facial treatment" className="img-small-bottom" />
      </div>
      ...
      <div className="include-section">
        ...
        <ul>
          <li>
          To determine your skin type and issues, a personalized consultation is necessary
          </li>
          <li>
          Solutions that are specific to your skin type, goals, and lifestyle
          </li>
          <li> For men, a refreshing and soothing facial experience.</li>
          <li>
          After your session, get professional advise on how to maintain healthy skin and long-lasting effects.
          </li>
        </ul>
      </div>
        ...
        <div className="menu-items">
          {menuItems.map((item, index) => (
            <div className="menu-item" key={index}>
              ...
              <span className="dots-dashes">- - - - - -</span>
      ...
      <button className="book-button" onClick={handleMenFacialBtn}>Book an appointment</button>
    </div>
  );
};

export default MenFacial;