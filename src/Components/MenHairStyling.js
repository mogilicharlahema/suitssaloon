...
const MenHairStyling = () => {
  ...
  return (
    <div className="men-hair-styling-container">
      <h1 className="main-title">Men Hair Styling</h1>

      <div className="men-image-gallery">
        <div className="men-large-image-wrapper">
          <img src={menh1} alt="Salon interior with washing stations" className="men-gallery-image large-image" />
        </div>
        <div className="men-small-images-wrapper">
          <img src={men2} alt="Close up of barber cutting hair" className="men-gallery-image-small-image" />
          <img src={men3} alt="Barber cutting hair with clippers" className="men-gallery-image-small-image" />
        </div>
      </div>
