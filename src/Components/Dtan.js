  ...
  return (
    <div className="dtan-container">
      ...
      <div className="dtan-image-section">
        ...
        <div className="dtan-image-left-wrapper">
          <img
            ...
            className="dtan-image dtan-image-left"
          />
        </div>
        ...
        <div className="dtan-image-right-wrapper">
          <img
            ...
            className="dtan-image dtan-image-right"
          />
          <img
            src={dtan3}
      ...
      <div className="dtan-include-section">
        <h2 className="dtan-section-title">
          What We Include In The Service
        </h2>
      ...
      <div className="dtan-menu-section">
        <h2 className="dtan-section-title dtan-text-center dtan-mb-6">
          Menu
        </h2>
        <div className="dtan-menu-content">
        
          <div className="dtan-menu-grid dtan-menu-header-row">
            <div className="dtan-font-semibold dtan-text-lg dtan-text-left"></div> 
            <div className="dtan-font-semibold dtan-text-lg dtan-text-right">Regular</div>
            <div className="dtan-font-semibold dtan-text-lg dtan-text-right">Advance</div>
          </div>

          <div className="dtan-menu-items-container">
            {menuItems.map((item, index) => (
              <div key={index} className="dtan-menu-grid dtan-menu-item-row">
                <div className="dtan-text-left">{item.name}</div>
                <div className="dtan-text-right">{item.regular}</div>
                <div className="dtan-text-right">{item.advance}</div>
              </div>
            ))}
          </div>
        </div>
