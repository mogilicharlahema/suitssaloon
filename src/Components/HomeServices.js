...
const HomeServiceSection = () => {
  const WomenServicesData = [
    ...
    { id: "waxing-threading", title: "Waxing & Threading", description: "Smooth skin, flawless look with our waxing/threading services.", image: waxing }, // Updated description
  ...
  const scrollRefWomen = useRef();
  const scrollRefMen = useRef();
